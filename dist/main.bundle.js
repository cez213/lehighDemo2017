...
module.exports = "<button md-button (click)=\"openDialog()\">Change Endpoint</button>\n"
...
EndpointSetterComponent = __decorate([
    ...
    __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Inject */])(__WEBPACK_IMPORTED_MODULE_2__angular_material__["a" /* MD_DIALOG_DATA */])),
...
module.exports = "<h3>Add or update a beverage</h3>\n<form #formDir=\"ngForm\" (ngSubmit)=\"onSubmit()\" [formGroup]=\"beverageForm\"\n      class=\"example-form\">\n  <md-form-field>\n    <input mdInput type=\"text\" placeholder=\"New beverage\" formControlName=\"name\"\n           autocomplete=\"off\">\n    <md-error *ngIf=\"beverageForm.get('name').hasError('required')\">\n      Beverage name is <strong>required</strong>\n    </md-error>\n  </md-form-field>\n  <md-form-field>\n    <input mdInput type=\"number\" placeholder=\"Quantity\" formControlName=\"value\"\n           autocomplete=\"off\">\n    <md-error *ngIf=\"beverageForm.get('value').hasError('required')\">\n      Quantity is <strong>required</strong>\n    </md-error>\n  </md-form-field>\n  <button md-raised-button color=\"primary\"\n          [disabled]=\"beverageForm.pristine\"\n          class=\"app-form-btn\"\n          type=\"submit\">Add</button>\n</form>\n"
...
var BeverageInputComponent = (function () {
    ...
    BeverageInputComponent.prototype.createForm = function () {
        this.beverageForm = this.fb.group({
            ...
            value: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["k" /* Validators */].required)
        });
    };
...
MaterialModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        exports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1__angular_material__["D" /* MdStepperModule */],
